...
resource "aws_batch_job_queue" "cpu" {
  ...
  priority = 1
  tags     = var.common_tags
  compute_environment_order { order = 1; compute_environment = aws_batch_compute_environment.cpu.arn }
}
...
resource "aws_batch_job_queue" "gpu" {
  ...
  priority = 1
  tags     = var.common_tags
  compute_environment_order { order = 1; compute_environment = aws_batch_compute_environment.gpu.arn }
}
